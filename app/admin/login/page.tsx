...
export default async function AdminLoginPage({
  ...
  return (
    <main className="relative flex min-h-[calc(100vh-10rem)] items-center justify-center overflow-hidden bg-[#fff7fa] px-4 py-12 text-[#38243c]">
      ...
      <section className="boutique-shadow relative w-full max-w-md rounded-[2.5rem] border border-white/80 bg-white/85 p-6 backdrop-blur sm:p-8">
        ...
        <p className="mt-3 text-sm leading-6 text-[#765c79]">
