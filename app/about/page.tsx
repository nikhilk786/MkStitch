    ...
    <main className="bg-[#fbf8ef] text-[#5C4F4A]">
      <section className="relative overflow-hidden bg-[#E4D6A9]">
        ...
        <div className="relative mx-auto grid w-full max-w-7xl gap-12 px-4 py-20 sm:px-6 lg:grid-cols-[0.9fr_1.1fr] lg:items-center lg:px-8">
          ...
          <Reveal delay={0.12}>
            <div className="boutique-shadow rounded-[2rem] border border-[#978F66]/20 bg-[#fffdf7]/58 p-8 backdrop-blur">
              <p className="font-editorial text-4xl font-semibold">
                ClothWeb is a quiet celebration of ethnic wear made for real life.
              </p>
          ...
          <Stagger className="mt-10 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
            {values.map(([title, description]) => (
              <StaggerItem key={title}>
                <div className="h-full rounded-2xl border border-[#978F66]/18 bg-[#fbf8ef] p-6 shadow-sm">
      ...
      <section className="px-4 py-20 sm:px-6 lg:px-8">
        <Reveal className="boutique-gradient boutique-shadow mx-auto grid w-full max-w-7xl gap-8 rounded-[2rem] border border-[#978F66]/20 p-8 sm:p-10 lg:grid-cols-[1fr_0.7fr] lg:items-center">
          <div>
            <p className="text-xs font-bold uppercase tracking-[0.26em] text-[#978F66]">
              Fabric quality
            </p>
          ...
          <Link
            href="/shop"
            className="inline-flex h-13 items-center justify-center rounded-full bg-[#5C4F4A] px-7 text-sm font-semibold text-white transition hover:-translate-y-0.5 hover:bg-[#978F66]"
          >
            Explore Kurtis
          </Link>
        </Reveal>
